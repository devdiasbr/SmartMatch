...
function useColors() {
  ...
  return {
    isDark: d,
    cardBg:        d ? 'rgba(255,255,255,0.03)' : 'rgba(0,0,0,0.02)',
    cardBorder:    d ? 'rgba(255,255,255,0.07)' : 'rgba(0,107,43,0.12)',
    heading:       d ? '#fff'                   : '#0D2818',
    muted:         d ? 'rgba(255,255,255,0.35)' : 'rgba(0,0,0,0.4)',
    mutedMid:      d ? 'rgba(255,255,255,0.25)' : 'rgba(0,0,0,0.3)',
    accentText:    d ? '#86efac'                : '#006B2B',
    accentBg:      d ? 'rgba(134,239,172,0.08)' : 'rgba(0,107,43,0.08)',
    accentBorder:  d ? 'rgba(134,239,172,0.18)' : 'rgba(0,107,43,0.2)',
    accentBorder2: d ? 'rgba(134,239,172,0.35)' : 'rgba(0,107,43,0.35)',
    accentBorder3: d ? 'rgba(134,239,172,0.3)'  : 'rgba(0,107,43,0.3)',
    buyBg:         d ? 'linear-gradient(135deg,rgba(22,101,52,0.9),rgba(21,128,61,0.85))' : 'linear-gradient(135deg,#006B2B,#00843D)',
    avatarBorder:  d ? 'rgba(255,255,255,0.1)'  : 'rgba(0,107,43,0.15)',
    avatarBg:      d ? 'rgba(255,255,255,0.05)' : 'rgba(0,107,43,0.04)',
    controlBg:     d ? 'rgba(255,255,255,0.05)' : 'rgba(0,0,0,0.04)',
    controlBorder: d ? 'rgba(255,255,255,0.07)' : 'rgba(0,107,43,0.1)',
    controlText:   d ? 'rgba(255,255,255,0.5)'  : 'rgba(0,0,0,0.4)',
    stripBorder:   d ? 'rgba(255,255,255,0.05)' : 'rgba(0,107,43,0.08)',
    ovlBg:         d ? 'rgba(0,0,0,0.55)'        : 'rgba(0,0,0,0.55)',
    buyInCartBg:   d ? 'rgba(134,239,172,0.2)'  : 'rgba(0,107,43,0.15)',
    inCartBadgeBg: d ? 'rgba(134,239,172,0.1)'  : 'rgba(0,107,43,0.08)',
    unidBg:        d ? 'rgba(255,255,255,0.015)' : 'rgba(0,0,0,0.015)',
    unidBorder:    d ? 'rgba(255,255,255,0.05)'  : 'rgba(0,107,43,0.07)',
    unidBadgeBg:   d ? 'rgba(255,255,255,0.05)'  : 'rgba(0,0,0,0.04)',
    unidBadgeBorder: d ? 'rgba(255,255,255,0.1)' : 'rgba(0,0,0,0.08)',
    unidBadgeText: d ? 'rgba(255,255,255,0.45)'  : 'rgba(0,0,0,0.45)',
    unidHeading:   d ? 'rgba(255,255,255,0.7)'   : 'rgba(0,0,0,0.65)',
    statBadgeBg:   d ? 'rgba(255,255,255,0.04)'  : 'rgba(0,0,0,0.04)',
    statBadgeBorder: d ? 'rgba(255,255,255,0.08)' : 'rgba(0,0,0,0.08)',
    statBadgeText: d ? 'rgba(255,255,255,0.4)'   : 'rgba(0,0,0,0.4)',
    errBg:         d ? 'rgba(252,165,165,0.07)'  : 'rgba(220,38,38,0.06)',
    errBorder:     d ? 'rgba(252,165,165,0.15)'  : 'rgba(220,38,38,0.15)',
    retryBg:       d ? 'rgba(255,255,255,0.05)'  : 'rgba(0,0,0,0.04)',
    retryBorder:   d ? 'rgba(255,255,255,0.1)'   : 'rgba(0,0,0,0.08)',
    emptyIconBg:   d ? 'rgba(255,255,255,0.04)'  : 'rgba(0,107,43,0.06)',
    emptyIconBorder: d ? 'rgba(255,255,255,0.07)' : 'rgba(0,107,43,0.1)',
    emptyIcon:     d ? 'rgba(255,255,255,0.2)'   : 'rgba(0,107,43,0.3)',
    spinTop:       d ? '#86efac'                  : '#006B2B',
    spinRight:     d ? 'rgba(134,239,172,0.15)'  : 'rgba(0,107,43,0.15)',
  };
}
